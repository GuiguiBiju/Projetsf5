...
class EmpruntRepository extends ServiceEntityRepository
{
    ...
    */
    //EXO: ecrire la fonction 'empruntsNonRendus' qui retourne les emprunts qui ont une date de retour nulle

    public function empruntsNonRendus()
    {
        /* SELECT * FROM emprunt e WHERE date_retour is NULL */
        return $this->createQueryBuilder('e') //le paramètre 'l' représente la table livre (comme un alias dans une requete sql)
